...
/*--------------------------------------------------------------
# Add / Edit Category - SaaS Modern UI
--------------------------------------------------------------*/
function fd_category_add_edit(){
    ...
    <style>
        ...
        /* Image Upload Zone */
        .fd-cat-upload-zone { 
            border: 2px dashed #dcdcde; border-radius: 12px; padding: 30px; text-align: center; 
            cursor: pointer; transition: 0.3s; background: #f9f9f9; position: relative;
        }
        ...
        .fd-remove-icon { position: absolute; top: 10px; right: 10px; color: #d63638; display: none; }
        ...
        .fd-btn-cancel:hover { color: #d63638; }
    </style>
